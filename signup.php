            ...
            <div class="input-boxes">
              ...
              <div class="input-box">
                ...
                <input type="tel" id="signup-mobile" name="mobile" placeholder="Enter your mobile number" required
                  pattern="\d{11}" title="Please enter a 11-digit mobile number">
              </div>
              <div class="input-box">
              ...
              <div class="input-box">
                ...
                <input type="password" id="signup-password" name="password" placeholder="Enter your password" required
                  ...
                  title="Must have 8+ chars, uppercase, number, special char">
              </div>
              <div class="input-box">
                <i class="fas fa-lock"></i>
        ...
        <div class="forgot-form">
          ...
          <form action="app/Controllers/AuthController.php?action=forgot_password" method="post">
            <div class="input-boxes">
              ...
              <div class="input-box">
                <i class="fas fa-phone"></i>
                <input type="tel" id="forgot-mobile" name="mobile" placeholder="Enter your mobile number" required
                  pattern="\d{11}">
              </div>
              <div class="input-box">
                <i class="fas fa-lock"></i>
              ...
              <div class="input-box">
                <i class="fas fa-lock"></i>
                <input type="password" id="forgot-confirm-password" name="confirm-password"
