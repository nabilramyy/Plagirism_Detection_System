                        ...
                        <?php foreach ($submissions as $submission): ?>
                            <div class="submission-card">
                                ...
                                <div class="actions" style="margin-top: 15px; margin-bottom: 15px;">
                                    ...
                                    <a href="/Plagirism_Detection_System/instructor_actions.php?action=view_report&id=<?php echo $submission['id']; ?>"
                                    ...
                                    <a href="/Plagirism_Detection_System/instructor_actions.php?action=download_report&id=<?php echo $submission['id']; ?>"
